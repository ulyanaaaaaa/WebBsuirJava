...
import jsonmarshlling.JsonAdapter;
...
class JAXBAPI {
    ...
    static void addFromJson(String filename, Session session) throws IOException {
        Gson gson = new GsonBuilder()
                .registerTypeAdapter(Date.class, new JsonAdapter())
                .setPrettyPrinting()
                .create();
